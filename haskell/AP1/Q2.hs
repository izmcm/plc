-- [Q2] Escreva uma função minMaxCartao :: String -> (Double, Double) 
-- que recebe uma String referente a fatura anual e 
-- retorna uma tupla com o menor e o maior dos valores gastos.
...
values str = [read(a!!3) ::Double | a <- toList str]

minMaxCartao :: String -> (Double, Double)
minMaxCartao str = (minimum (values str), maximum (values str))

main = do print(minMaxCartao logCartao)